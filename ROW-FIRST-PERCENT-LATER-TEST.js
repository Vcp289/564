...
const canonical=fs.readFileSync('history-analysis-core-v72308.js','utf8');
...
const checks=[
 ...
 ['row publish occurs before percent-later timer', hybrid.indexOf("commitRow(id,d,statuses,'atomic-row-final')") < hybrid.indexOf('setTimeout(async()=>')],
 ...
 ['service worker caches hybrid core', /hybrid-core-v72308\.js/.test(fs.readFileSync('sw-v72308.js','utf8'))]
];
