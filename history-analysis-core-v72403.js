/* LuckyNumber V7.24.03 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.24.03 ROW-FIRST: read exactly one canonical row without running snapshot(),
