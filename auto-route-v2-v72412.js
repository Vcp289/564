/* LuckyNumber V7.24.12 — AUTO Route V2 PRO
...
(function(global){
  ...
  const LOCK_KEY='luckyNumber_auto_route_v2_lock_v72412_state';
  const MIN_TOTAL=14;
  ...
  function decide(profileId){
    ...
    // V7.24.12: restoration completion and model coverage are different states.
