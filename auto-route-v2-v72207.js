/* LuckyNumber V7.22.07 — AUTO Route V2 PRO
 * NEW ENGINE. The V7.22.06 selector is intentionally retained in app-v72207.js as fallback.
...
(function(global){
  ...
  const LOCK_KEY='luckyNumber_auto_route_v2_lock_v72207';
  const MIN_TOTAL=14;
