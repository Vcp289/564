const CACHE = "lucky-number-v7-20-21-unified-ai-registry-standard-20260823";
const CACHE_PREFIX = "lucky-number-";
const ASSETS = [
  "./",
  "./index.html",
  "./style-r42.css?v=72021unifiedregistry",
  "./app-r42.js?v=72021unifiedregistry",
  "./manifest.json?v=72021unifiedregistry",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
