const CACHE = "lucky-number-v7-20-11-p19-x3-priority-daily-20260822";
const CACHE_PREFIX = "lucky-number-";
const ASSETS = [
  "./",
  "./index.html",
  "./style-r42.css?v=72011p19priority",
  "./app-r42.js?v=72011p19priority",
  "./manifest.json?v=72011p19priority",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
