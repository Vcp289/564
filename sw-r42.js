const CACHE = "lucky-number-v7-19-21-clean-calculator-fast-ios-smooth-20260821";
const CACHE_PREFIX = "lucky-number-";
const ASSETS = [
  "./",
  "./index.html",
  "./style-r42.css?v=71921cleancalcfast",
  "./app-r42.js?v=71921cleancalcfast",
  "./manifest.json?v=71921cleancalcfast",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
