...
`${RELEASE}app.js`,`${RELEASE}cloud-restore-bridge.js`,`${RELEASE}history-row-identity-fix.js`,`${RELEASE}history-import-ocr.js`,`${RELEASE}history-ai-status-idle.js`,`${RELEASE}x4-native.js`,`${RELEASE}history-analysis-core.js`,`${RELEASE}hybrid-core.js`,`${RELEASE}cloud-sync.js`,`${RELEASE}x3-pro.js`,
