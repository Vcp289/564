const BUILD = "81431turbo6";
const CACHE_PREFIX = "lucky-number-shell-";
const CACHE = `${CACHE_PREFIX}${BUILD}-v816-x4-coverage-577`;
...
const CORE = [
  ...
  `${RELEASE}app.js`,`${RELEASE}history-analysis-core.js`,`${RELEASE}hybrid-core.js`,`${RELEASE}x3-pro.js`,`${RELEASE}x4-coverage.js`,
