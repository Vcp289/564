/* LuckyNumber V7.24.00 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.24.00 ROW-FIRST: read exactly one canonical row without running snapshot(),
