/* LuckyNumber V7.24.01 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.24.01 ROW-FIRST: read exactly one canonical row without running snapshot(),
