/* LuckyNumber V7.20.86p — AI PICK · TEST
...
(()=>{
  'use strict';
  const SCHEMA=1;
  const LS_KEY='lucky_ai_pick_test_daily_v72086p';
  const IDB_PREFIX='ai-pick-test-daily-v72086p-';
  const MAX_PRIOR=120;
  ...
  globalThis.AIPickPro={renderCard,refresh,schedule,clear,current,compute,version:'7.20.86p-ai-pick-fallback'};
