...
(function(global){
  ...
  const active=Object.freeze(['classic','aiL','gl','p18','p19','x3','x4']);
  const autoNames=Object.freeze({classic:'original',aiL:'ai',gl:'gl',p18:'pattern',p19:'p19',x3:'x3',x4:'x4'});
  const labels=Object.freeze({classic:'Classic L',aiL:'AI L',gl:'AI GL',p18:'P18',p19:'P19',x3:'X3',x4:'X4'});
  ...
  function readiness(id,profileId){
    ...
    if(id==='x4') return {ready:typeof global.buildX4Candidates==='function',reason:'runtime'};
  ...
  function selfTest(){
    ...
    return Object.freeze({ok:unique&&active.length===7&&normalize('notfound')==='miss',version:VERSION,engines:active.slice()});
  }
