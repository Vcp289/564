...
const ENGINES=(globalThis.LuckyEngineRegistry?.canonicalIds?.()||['classic','aiL','gl','p18','p19','x3','x4']).slice();
...
if(needs('x4')){try{out.x4=cleanStatus(x4HistoryStatus(draw,id));}catch(_){out.x4='pending';}}
return out;
}
