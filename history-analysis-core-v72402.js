/* LuckyNumber V7.24.02 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.24.02 ROW-FIRST: read exactly one canonical row without running snapshot(),
