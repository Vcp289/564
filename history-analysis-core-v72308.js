/* LuckyNumber V7.23.08 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.23.08 ROW-FIRST: read exactly one canonical row without running snapshot(),
