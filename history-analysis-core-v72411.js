/* LuckyNumber V7.24.11 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.24.11 ROW-FIRST: read exactly one canonical row without running snapshot(),
  ...
  function snapshot(profileId,draws=getProfileDraws(profileId)){
    ...
    // V7.24.11 ALL-ROWS VISIBLE BRIDGE.
