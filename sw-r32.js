const CACHE = "lucky-number-v7-09-36-auto-ready-pool-20260818";
const CACHE_PREFIX = "lucky-number-";
const ASSETS = [
  "./",
  "./index.html",
  "./style-r32.css?v=70936autoreadypool",
  "./app-r32.js?v=70936autoreadypool",
  "./manifest.json?v=70936autoreadypool",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
