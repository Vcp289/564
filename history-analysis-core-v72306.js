/* LuckyNumber V7.23.06 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.23.06 ROW-FIRST: read exactly one canonical row without running snapshot(),
