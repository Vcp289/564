...
const APP_VERSION = "7.09.8-HISTORY-AUTO-CHOICE";
const APP_DISPLAY_VERSION = "V7.09.8 • Master AI";
...
if ("serviceWorker" in navigator) window.addEventListener("load", async () => {
  try {
    ...
    const reg = await navigator.serviceWorker.register("sw-r23.js?v=7098historyauto", { updateViaCache: "none" });
    reg.update().catch(()=>{});
