/* LuckyNumber V7.23.09 — NEW Canonical History/Analysis Core
...
(() => {
  ...
  // V7.23.09 ROW-FIRST: read exactly one canonical row without running snapshot(),
